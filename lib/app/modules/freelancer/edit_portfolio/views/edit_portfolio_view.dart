...
class EditPortfolioView extends GetView<EditPortfolioController> {
  const EditPortfolioView({super.key});
  @override
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    InkWell(
                      ...
                      child: Obx(
                          ...
                          return Ink(
                            height: 150,
                            decoration: BoxDecoration(
                              color: controller.portfolioImage.path.isNotEmpty || controller.networkPortfolioImageUrl.fileName.isNotEmpty
                                  ? null
                                  : AppColors.white.withOpacity(0.1),
                              image: controller.portfolioImage.path.isNotEmpty || controller.networkPortfolioImageUrl.fileName.isNotEmpty
                                  ? DecorationImage(
                                image: controller.isPortfolioImageChanged
                                    ? FileImage(controller.portfolioImage)
                                    : NetworkImage(
                                  SupabaseService
                                      .getPortfolioImageDownloadUrl(
                                    controller
                                        .networkPortfolioImageUrl
                                        .fileName,
                                  ),
                                ),
                                opacity: 0.5,
                    ...
                    const Gap(50),
                    AppElevatedButton(
                      onPressed: controller.updatePortfolio,
                      child: Text(
                        'Update Portfolio',
                        style: 14.0.medium,
                      ),
